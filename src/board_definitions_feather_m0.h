...
#define STRING_PRODUCT      "Feather M0"
...
#define SPI_PM_APBCMASK                   PM_APBCMASK_SERCOM4
#define SPI_PER_CLOCK_ID                  GCLK_CLKCTRL_ID_SERCOM4_CORE_Val

// See page 493: https://cdn.sparkfun.com/datasheets/Dev/Arduino/Boards/Atmel-42181-SAM-D21_Datasheet.pdf
#define SPI_OUTPUT_PINOUT                 (1U)          // PAD2=MOSI, PAD3=SCK
#define SPI_INPUT_PINOUT                  (0U)          // PAD0=MISO

// These come from CMSIS-Atmel/CMSIS/CMSIS/Device/ATMEL/samd21/include/pio/samd21g18a.h
#define SPI_MISO                          PINMUX_PA12D_SERCOM4_PAD0
#define SPI_MOSI                          PINMUX_PB10D_SERCOM4_PAD2
#define SPI_SCK                           PINMUX_PB11D_SERCOM4_PAD3
